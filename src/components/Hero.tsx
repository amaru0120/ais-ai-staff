        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden text-white">
            ...
            <div className="container mx-auto px-6 relative z-30">
                <div className="max-w-5xl mx-auto text-center relative">
                    ...
                    >
                        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 mx-auto max-w-6xl text-white text-wrap-balance">
                    ...
                    <motion.p
                        ...
                        className="text-base sm:text-lg md:text-xl lg:text-2xl text-white mb-12 leading-relaxed max-w-4xl mx-auto px-4 drop-shadow-lg font-medium text-wrap-balance"
                    >
