        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden text-white">
            ...
            <div className="container mx-auto px-6 relative z-30">
                <div className="max-w-5xl mx-auto text-center relative">
                    ...
                    >
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 mx-auto max-w-6xl text-white">
                            その『面倒』、AI従業員に<br className="md:hidden" />
                            <span className="text-accent text-glow block md:inline mt-2 md:mt-0 md:ml-3 text-glow-blue whitespace-nowrap">月給33,000円で任せませんか？</span>
                        </h1>
                    </motion.div>
                    ...
                    <motion.p
                        ...
                        className="text-lg md:text-xl lg:text-2xl text-white mb-12 leading-relaxed max-w-4xl mx-auto px-4 drop-shadow-lg font-medium"
                    >
