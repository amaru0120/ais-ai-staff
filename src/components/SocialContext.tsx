...
export const SocialContext = () => {
    return (
        <section className="py-24 bg-[#0f172a] overflow-hidden text-white">
            <div className="container mx-auto px-6">
                ...
                >
                    <h2 className="text-2xl md:text-5xl font-bold mb-6 tracking-tight text-white leading-snug">
                        2026年、AIを使わないことは
                        <br className="hidden md:block" />
                        <span className="text-red-500 block mt-2">「撤退」を意味します。</span>
                    </h2>
                    <p className="text-base md:text-xl text-gray-400 max-w-3xl mx-auto font-medium leading-relaxed text-balance">
